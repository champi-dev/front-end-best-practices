...
The state management pattern aids in giving us clarity about our data flow. Use this pattern when your app has *global* data that many sibling components may share.
...
Vuex docs are crystal clear and you should take the time to read them and understand how to use it properly.
...
I'll expand on this in the `App architecture` chapter.
